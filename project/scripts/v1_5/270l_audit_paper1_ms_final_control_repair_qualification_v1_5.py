#!/usr/bin/env python3
"""Audit the frozen 24-call MS final-control-repair fresh-identity qualification."""
...
RAW = ROOT / "outputs/pm_v1_5_paper1_ms_final_control_repair_live_20260812/raw_provider_outputs_before_local_validation.jsonl"
KEY = ROOT / "outputs/pm_v1_5_paper1_ms_final_control_repair_private_20260812/final_control_repair_key.jsonl"
OUT = ROOT / "outputs/pm_v1_5_paper1_ms_final_control_repair_qualification_audit_20260812"
...
def main() -> None:
    ...
    primary = by_reviewer.get("MS_FINAL_PRIMARY_GPT56", {})
    challenger = by_reviewer.get("MS_FINAL_CHALLENGER_GEMINI", {})
    gates = {
    ...
    # Same per-family USD rates as configs/paper1_ms_source_annotated_review_endpoints_v1.json.
    RATES = {
        "MS_FINAL_PRIMARY_GPT56": {"input": 5.0, "output": 30.0},
        "MS_FINAL_CHALLENGER_GEMINI": {"input": 0.3, "output": 2.5},
    }
    cost_usd = 0.0
    for row in results:
    ...
    report = {
        "protocol": "pm-v1.5-paper1-ms-final-control-repair-qualification-audit-v1",
        "status": (
            ...
            else "QUALIFICATION_FAIL_MS_LABEL_ROUTE_MUST_BE_RETIRED_PER_PRE_REGISTERED_FALLBACK"
        ),
        "gates": gates,
