...
- **The 2026-09-17 qualification closeout has scoped precedence for completed-review provenance, candidate disposition and execution progress.** Read `project/data/paper1_authority/paper1_gemini_qualification_closeout_20260917_v1.json` and `project/docs/PM_PAPER1_GEMINI_QUALIFICATION_RESULTS_20260917_ZH.md`. The completed A sheet is a joint-human review; six-case followup and assistant fact sensitivity stay separate, and AI B is exploratory. Do not request another full human sheet or invent independent inter-human agreement. The researcher approved the USD 0.10 frozen qualification; 100 physical calls completed 96 presentations, with 92 valid verdicts, four parser failures, and USD 0.0654614 conservatively accounted. This candidate was not promoted; apply the existing V3 weak-teacher fallback. Nonzero provider-reported thinking usage is disclosed despite unchanged `thinkingBudget=0` requests. Original identity/proposal counters remain historical snapshots. This closeout opens no calibration/confirmatory lock and authorizes no PM training.
- **The 2026-09-08 human-reference V2 amendment has scoped precedence** for DG reference evidence, the corresponding teacher rubric/payload, offline human forms and ingest. The original design requested two independent 96-item reviews; the completed-review provenance is now described by the 2026-09-17 closeout above. All 142 replies and original item orders are preserved. DG includes the unchanged related-history excerpt and complete strict-past raw history, identical for humans and the teacher. V1 sheets remain provenance. The V2 amendment itself authorized no Gemini call, formal outcome, PM training, budget increase or new empirical gate.
...
2. Use the completed 2026-09-08 V2 80-base/16-reversal package and the 2026-09-17 actual joint-human-reference closeout. Preserve original A, exploratory AI B and six-case followup bytes; keep posthoc sensitivity separate. Unresolved cases remain uncertain. Do not restart human review or use returned ratings as editable blank templates.
